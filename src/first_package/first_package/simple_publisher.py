...
class MinimalPublisher(Node):
    def __init__(self):
        ...
        super().__init__('node_gmarin_pub')  # <-- Replace 'NICKNAME' with your actual group number
        
        # Step 2: Create a publisher for your topic
        # Replace 'topic_ID' with a unique topic name (e.g., 'topic_1' for Group 1)
        self.publisher_ = self.create_publisher(String, 'topic_1', 10)  # <-- Replace 'NICKNAME'
    ...
    def timer_callback(self):
        ...
        msg.data = f"gmarin says hello! This is message #{self.i}"  # <-- Replace 'NICKNAME'
