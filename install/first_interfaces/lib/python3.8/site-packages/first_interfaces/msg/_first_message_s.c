...
bool first_interfaces__msg__first_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("first_interfaces.msg._first_message.FirstMessage", full_classname_dest, 48) == 0);
  }
  first_interfaces__msg__FirstMessage * ros_message = _ros_message;
  {  // temperatures
...
{
  /* NOTE(esteve): Call constructor of FirstMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("first_interfaces.msg._first_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FirstMessage");
